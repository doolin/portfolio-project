...
describe "projects/index.html.erb" do
  ...
  context "with 2 projects" do
    ...
    it "renders a list of projects" do
      ...
      rendered.should have_selector('tr>th', :content => 'Project name')
      rendered.should have_selector('tr>th', :content => 'Summary')
      rendered.should have_selector('tr>th', :content => 'Tags')
    end
